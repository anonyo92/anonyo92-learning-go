 ...
 * the sort package’s generic Sort function. 
...
func RunSortByFunctions() {
	/* we can now implement our custom sort by converting the original fruits slice to byLength, 
